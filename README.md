...
| [modstitch-manifests](./modstitch-manifests/README.md)     | 0.1.5          | A Gradle plugin to help generate mod metadata files (e.g.                                   |
...
| [modstitch-multiloader](./modstitch-multiloader/README.md) | 0.1.8          | A Gradle plugin providing conventions for source-set-based multi-loader.                    |
